...
`.claude/hooks/review-gate.sh` (wired in `.claude/settings.local.json`) denies `gh pr create` until this skill has run **and** is newer than the last edit. Consequences worth knowing:
