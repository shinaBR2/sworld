...
See `.claude/references/good-diff.md` for the good-diff/PR criteria (one purpose, low risk, covered by a test) — the same "is this a good diff?" judgement from the other axis.
