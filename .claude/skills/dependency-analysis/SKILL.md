...
We ship as fast as we can, and merging is deploying (see `.claude/references/deployment-model.md`). So "isolated" does not mean "structurally unrelated." It means one thing:
