...
describe('PlayingList', () => {
  ...
  it('renders audio list items', () => {
    render(<PlayingList audioList={mockAudioList} currentId="" onSelect={() => () => {}} />);
  ...
  it('shows playing for selected item', () => {
    render(<PlayingList audioList={mockAudioList} currentId="1" onSelect={() => () => {}} />);
  ...
  it('calls onSelect with correct id', () => {
    ...
    render(<PlayingList audioList={mockAudioList} currentId="" onSelect={mockOnSelect} />);
  ...
  it('truncates long text', () => {
    ...
    render(<PlayingList audioList={[{ id: '1', name: longName }]} currentId="" onSelect={() => () => {}} />);
